            	...
            	<div class="row">
                	<div class="col-md-10 col-lg-10 mb-3 " id="divId">
                    	<label for="inputId"><strong>아이디</strong></label>
                       	<input type="text" class="form-control" id="userid" name="userid" data-rule-required="true" placeholder="" value ="" onkeydown='javascript_:{ if(event.keyCode==13) event.returnValue=false;}'>
               		</div>
